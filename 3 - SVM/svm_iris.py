...
plt.sca(ax[0])
svm1 = SVC(kernel='rbf', random_state=1, gamma=0.1, C=1.0) # SVM with gamma=0.1
...
plt.sca(ax[1])
svm2 = SVC(kernel='rbf', random_state=1, gamma=100.0, C=1.0) # SVM with gamma=100.0, very tight boundaries
